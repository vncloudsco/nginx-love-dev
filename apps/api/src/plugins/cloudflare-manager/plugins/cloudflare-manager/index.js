...
const plugin_sdk_1 = require("../../shared/plugin-sdk");
const express_1 = require("express");
const cloudflare_client_1 = require("./services/cloudflare-client");
class CloudflareManagerPlugin extends plugin_sdk_1.BasePlugin {
    constructor() {
        super(...arguments);
        this.metadata = {
            ...
            type: plugin_sdk_1.PluginType.INTEGRATION,
            license: 'MIT',
        };
        this.cfClient = null;
        this.syncTimer = null;
    ...
    async initialize(context) {
        ...
        this.cfClient = new cloudflare_client_1.CloudflareClient({
...
exports.default = CloudflareManagerPlugin;
